...
Patch113: krb5-1.10-pkinit-null.patch
Patch114: krb5-1.10-pkinit-agility.patch
Patch115: krb5-1.10-CVE-2013-1416.patch
Patch116: krb5-1.11.2-kpasswd_pingpong.patch
Patch117: krb5-1.10.2-gic_keytab_leak.patch
Patch500: krb5-1.10.3-hst_realm.patch
...
%patch113 -p1 -b .pkinit-null
%patch114 -p1 -b .pkinit-agility
%patch115 -p1 -b .CVE-2013-1416
%patch116 -p1 -b .kpasswd_pingpong
%patch117 -p1 -b .gic_keytab_leak
%patch500 -p1 -b .hst_realm
...
%docdir %{_mandir}
%verify(not md5 size mtime)  /etc/krb5.conf
...
%changelog
* Wed Jun 26 2013 Nalin Dahyabhai <nalin@redhat.com> 1.10.3-10.4
